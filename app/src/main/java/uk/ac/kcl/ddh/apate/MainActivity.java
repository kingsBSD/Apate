...
import uk.ac.kcl.ddh.apate.capture.CaptureService;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setCaptureState(boolean state) {
        if (state) {
            toolbar.getMenu().getItem(0).setIcon(R.drawable.ic_icon_eye);
        } else {
            toolbar.getMenu().getItem(0).setIcon(R.drawable.ic_icon_eyeclosed);
        }
        captureState = state;
    }
    ...
    public void startCapture() {
        ...
        if (sharedPref.getBoolean("pref_key_capture_cells", false)) {
